...
Partial Class frmRegistraAguaPorCuenta
    ...
    Private Sub InitializeComponent()
        ...
        Dim UltraGridColumn16 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("id_ruta")
        ...
        Dim UltraGridColumn18 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("cve_status")
        ...
        Dim UltraGridColumn20 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("cve_tip_con")
        Dim UltraGridColumn21 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("descricion")
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmRegistraAguaPorCuenta))
        Dim Appearance34 As Infragistics.Win.Appearance = New Infragistics.Win.Appearance()
        Dim UltraGridBand4 As Infragistics.Win.UltraWinGrid.UltraGridBand = New Infragistics.Win.UltraWinGrid.UltraGridBand("tbl_consumo_agua", -1)
        Dim UltraGridColumn22 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("idConsumo")
        Dim UltraGridColumn23 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("num_cuenta")
        Dim Appearance35 As Infragistics.Win.Appearance = New Infragistics.Win.Appearance()
        Dim UltraGridColumn24 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("año")
        Dim Appearance36 As Infragistics.Win.Appearance = New Infragistics.Win.Appearance()
        Dim UltraGridColumn25 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("bimestre")
        Dim Appearance37 As Infragistics.Win.Appearance = New Infragistics.Win.Appearance()
        Dim UltraGridColumn26 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("consumo_bim")
        Dim Appearance38 As Infragistics.Win.Appearance = New Infragistics.Win.Appearance()
        Dim UltraGridColumn27 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("lect_act")
        Dim Appearance39 As Infragistics.Win.Appearance = New Infragistics.Win.Appearance()
        Dim UltraGridColumn28 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("lect_ant")
        Dim Appearance40 As Infragistics.Win.Appearance = New Infragistics.Win.Appearance()
        Dim UltraGridColumn29 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("fec_captura")
        Dim Appearance41 As Infragistics.Win.Appearance = New Infragistics.Win.Appearance()
        Dim UltraGridColumn38 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("Id_Incidencia")
        Dim UltraGridColumn30 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("usuario")
        Dim UltraGridColumn1 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IdRuta")
        Dim UltraGridColumn40 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("Descripcion", 0)
        ...
        Me.uneUltimaLectura = New Infragistics.Win.UltraWinEditors.UltraNumericEditor()
        Me.txtNoServs = New Infragistics.Win.UltraWinEditors.UltraNumericEditor()
        Me.ucoRuta = New Infragistics.Win.UltraWinGrid.UltraCombo()
        Me.lblUltLectura = New Infragistics.Win.Misc.UltraLabel()
        Me.lblNumServs = New Infragistics.Win.Misc.UltraLabel()
        ...
        Me.txtFechaContrato = New Infragistics.Win.UltraWinEditors.UltraDateTimeEditor()
        Me.lblContrato = New Infragistics.Win.Misc.UltraLabel()
        Me.lblMedidor = New Infragistics.Win.Misc.UltraLabel()
        Me.cmbMedidor = New System.Windows.Forms.ComboBox()
        Me.chkDrenaje = New System.Windows.Forms.CheckBox()
        Me.txtCuenta = New System.Windows.Forms.MaskedTextBox()
        Me.grpRegistro = New Infragistics.Win.Misc.UltraExpandableGroupBox()
        Me.UltraExpandableGroupBoxPanel2 = New Infragistics.Win.Misc.UltraExpandableGroupBoxPanel()
        Me.txtFechaCaptura = New Infragistics.Win.UltraWinEditors.UltraDateTimeEditor()
        Me.TblconsumoaguaBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsAguaBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.UltraLabel3 = New Infragistics.Win.Misc.UltraLabel()
        Me.txtBimestre = New Infragistics.Win.UltraWinEditors.UltraTextEditor()
        Me.UltraLabel2 = New Infragistics.Win.Misc.UltraLabel()
        Me.txtAño = New Infragistics.Win.UltraWinEditors.UltraTextEditor()
        ...
        Me.ColoniasBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.ErrorProvider1 = New System.Windows.Forms.ErrorProvider(Me.components)
        Me.ColoniasTableAdapter = New TCMAdmin.dsAguaTableAdapters.coloniasTableAdapter()
        Me.grpConsumo = New Infragistics.Win.Misc.UltraExpandableGroupBox()
        ...
        CType(Me.uneUltimaLectura, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.txtNoServs, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.ucoRuta, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.txtFechaContrato, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.grpRegistro, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.grpRegistro.SuspendLayout()
        Me.UltraExpandableGroupBoxPanel2.SuspendLayout()
        CType(Me.txtFechaCaptura, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.TblconsumoaguaBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.DsAguaBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.txtBimestre, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.ColoniasBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.ErrorProvider1, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.grpConsumo, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.grpConsumo.SuspendLayout()
        ...
        Me.BindingNavigator1.BindingSource = Me.ArcaguaBindingSource
        ...
        Me.ArcaguaBindingSource.DataSource = Me.DsAgua
        '
        'DsAgua
        '
        ...
        Me.btnEditar.ToolTipText = "Editar lecturas"
        '
        'ToolStripSeparator2
        '
        ...
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.grpServicio)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.grpTipoUsuario)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.uneUltAnio)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.ucoUltMes)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.lblUltAño)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.lblUltMes)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.uneUltimaLectura)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.txtNoServs)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.ucoRuta)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.lblUltLectura)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.lblNumServs)
        ...
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.txtFechaContrato)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.lblContrato)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.lblMedidor)
        Me.UltraExpandableGroupBoxPanel1.Controls.Add(Me.cmbMedidor)
        ...
        Me.optTipoServicio.Appearance = Appearance3
        ...
        Me.optTipoServicio.ItemAppearance = Appearance4
        ...
        Appearance5.BorderColor3DBase = System.Drawing.Color.Silver
        Me.grpTipoUsuario.Appearance = Appearance5
        ...
        Me.optUsuario.Appearance = Appearance6
        ...
        Me.optUsuario.ItemAppearance = Appearance7
        Appearance8.FontData.BoldAsString = "False"
        ValueListItem5.Appearance = Appearance8
        ValueListItem5.DataValue = "1"
        ValueListItem5.DisplayText = "Doméstico"
        Appearance9.FontData.BoldAsString = "False"
        ValueListItem6.Appearance = Appearance9
        ...
        'ucoUltMes
        '
        Me.ucoUltMes.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.ArcaguaBindingSource, "ult_mes_pago", True))
        ...
        Me.ucoRuta.Appearance = Appearance12
        Me.ucoRuta.AutoCompleteMode = Infragistics.Win.AutoCompleteMode.Suggest
        Me.ucoRuta.AutoSuggestFilterMode = Infragistics.Win.AutoSuggestFilterMode.Contains
        Me.ucoRuta.DataBindings.Add(New System.Windows.Forms.Binding("Value", Me.ArcaguaBindingSource, "id_ruta", True))
        UltraGridBand1.ColHeadersVisible = False
        UltraGridColumn16.Header.VisiblePosition = 0
        UltraGridColumn16.Hidden = True
        UltraGridColumn17.Header.VisiblePosition = 1
        UltraGridColumn17.Width = 330
        UltraGridBand1.Columns.AddRange(New Object() {UltraGridColumn16, UltraGridColumn17})
        Me.ucoRuta.DisplayLayout.BandsSerializer.Add(UltraGridBand1)
        ...
        Me.ucoStatus.Appearance = Appearance19
        ...
        Me.ucoStatus.DataBindings.Add(New System.Windows.Forms.Binding("Value", Me.ArcaguaBindingSource, "status", True))
        UltraGridBand2.ColHeadersVisible = False
        UltraGridColumn18.Header.VisiblePosition = 0
        UltraGridColumn18.Hidden = True
        UltraGridColumn19.Header.VisiblePosition = 1
        UltraGridColumn19.Width = 330
        UltraGridBand2.Columns.AddRange(New Object() {UltraGridColumn18, UltraGridColumn19})
        Me.ucoStatus.DisplayLayout.BandsSerializer.Add(UltraGridBand2)
        ...
        Me.ucoTipoContribuyente.Appearance = Appearance20
        ...
        Me.ucoTipoContribuyente.DataBindings.Add(New System.Windows.Forms.Binding("Value", Me.ArcaguaBindingSource, "cve_tip_con", True))
        UltraGridBand3.ColHeadersVisible = False
        UltraGridColumn20.Header.VisiblePosition = 0
        UltraGridColumn20.Hidden = True
        UltraGridColumn21.Header.VisiblePosition = 1
        UltraGridColumn21.Width = 330
        UltraGridBand3.Columns.AddRange(New Object() {UltraGridColumn20, UltraGridColumn21})
        Me.ucoTipoContribuyente.DisplayLayout.BandsSerializer.Add(UltraGridBand3)
        ...
        '
        Me.UltraExpandableGroupBoxPanel2.Controls.Add(Me.txtFechaCaptura)
        Me.UltraExpandableGroupBoxPanel2.Controls.Add(Me.UltraLabel3)
        Me.UltraExpandableGroupBoxPanel2.Controls.Add(Me.txtBimestre)
        Me.UltraExpandableGroupBoxPanel2.Controls.Add(Me.UltraLabel2)
        Me.UltraExpandableGroupBoxPanel2.Controls.Add(Me.txtAño)
        Me.UltraExpandableGroupBoxPanel2.Controls.Add(Me.txtConsumo)
        Me.UltraExpandableGroupBoxPanel2.Controls.Add(Me.UltraLabel7)
        Me.UltraExpandableGroupBoxPanel2.Controls.Add(Me.UltraLabel6)
        Me.UltraExpandableGroupBoxPanel2.Controls.Add(Me.uneLecturaActual)
        Me.UltraExpandableGroupBoxPanel2.Controls.Add(Me.UltraLabel1)
        Me.UltraExpandableGroupBoxPanel2.Controls.Add(Me.uneLecturaAnterior)
        ...
        Me.txtFechaCaptura.Appearance = Appearance25
        Me.txtFechaCaptura.BackColor = System.Drawing.Color.White
        ...
        '
        'TblconsumoaguaBindingSource
        '
        Me.TblconsumoaguaBindingSource.DataMember = "tbl_consumo_agua"
        Me.TblconsumoaguaBindingSource.DataSource = Me.DsAguaBindingSource
        '
        'DsAguaBindingSource
        '
        Me.DsAguaBindingSource.DataSource = Me.DsAgua
        Me.DsAguaBindingSource.Position = 0
        '
        'UltraLabel3
        '
        ...
        Me.txtConsumo.Appearance = Appearance28
        ...
        Appearance29.BorderColor = System.Drawing.Color.FromArgb(CType(CType(224, Byte), Integer), CType(CType(224, Byte), Integer), CType(CType(224, Byte), Integer))
        ...
        ValueListItem4.DisplayText = "Por promedio de tres últimas lecturas"
        ...
        '
        Me.ColoniasBindingSource.DataMember = "colonias"
        Me.ColoniasBindingSource.DataSource = Me.DsAgua
        '
        'ErrorProvider1
        '
        ...
        '
        Me.ColoniasTableAdapter.ClearBeforeFill = True
        '
        'grpConsumo
        '
        ...
        'grdDataMain
        '
        Me.grdDataMain.DataSource = Me.TblconsumoaguaBindingSource
        Appearance32.BackColor = System.Drawing.Color.White
        Appearance32.BackColor2 = System.Drawing.Color.FromArgb(CType(CType(221, Byte), Integer), CType(CType(221, Byte), Integer), CType(CType(221, Byte), Integer))
        ...
        Me.grdDataMain.DisplayLayout.AddNewBox.Appearance = Appearance32
        Me.grdDataMain.DisplayLayout.AddNewBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.None
        Appearance33.ForeColor = System.Drawing.Color.FromArgb(CType(CType(21, Byte), Integer), CType(CType(27, Byte), Integer), CType(CType(85, Byte), Integer))
        Appearance33.ImageBackground = CType(resources.GetObject("Appearance33.ImageBackground"), System.Drawing.Image)
        Appearance33.ImageBackgroundAlpha = Infragistics.Win.Alpha.UseAlphaLevel
        ...
        Me.grdDataMain.DisplayLayout.AddNewBox.ButtonAppearance = Appearance33
        Me.grdDataMain.DisplayLayout.AddNewBox.ButtonConnectorColor = System.Drawing.Color.FromArgb(CType(CType(21, Byte), Integer), CType(CType(27, Byte), Integer), CType(CType(85, Byte), Integer))
        Me.grdDataMain.DisplayLayout.AddNewBox.ButtonStyle = Infragistics.Win.UIElementButtonStyle.FlatBorderless
        Appearance34.BackColor = System.Drawing.Color.White
        Me.grdDataMain.DisplayLayout.Appearance = Appearance34
        ...
        UltraGridColumn22.Header.Caption = "Id"
        ...
        UltraGridColumn23.CellAppearance = Appearance35
        ...
        Appearance42.FontData.Name = "Trebuchet MS"
        Appearance42.FontData.SizeInPoints = 9.0!
        Appearance42.ForeColor = System.Drawing.Color.White
        Appearance42.TextHAlignAsString = "Right"
        Me.grdDataMain.DisplayLayout.CaptionAppearance = Appearance42
        ...
        Me.grdDataMain.DisplayLayout.FixedHeaderOffImage = CType(resources.GetObject("grdDataMain.DisplayLayout.FixedHeaderOffImage"), System.Drawing.Image)
        Me.grdDataMain.DisplayLayout.FixedHeaderOnImage = CType(resources.GetObject("grdDataMain.DisplayLayout.FixedHeaderOnImage"), System.Drawing.Image)
        Me.grdDataMain.DisplayLayout.FixedRowOffImage = CType(resources.GetObject("grdDataMain.DisplayLayout.FixedRowOffImage"), System.Drawing.Image)
        Me.grdDataMain.DisplayLayout.FixedRowOnImage = CType(resources.GetObject("grdDataMain.DisplayLayout.FixedRowOnImage"), System.Drawing.Image)
        Appearance43.FontData.BoldAsString = "True"
        Appearance43.FontData.Name = "Trebuchet MS"
        Appearance43.FontData.SizeInPoints = 10.0!
        Appearance43.ForeColor = System.Drawing.Color.FromArgb(CType(CType(60, Byte), Integer), CType(CType(127, Byte), Integer), CType(CType(177, Byte), Integer))
        Appearance43.ImageBackground = CType(resources.GetObject("Appearance43.ImageBackground"), System.Drawing.Image)
        Appearance43.ImageBackgroundStretchMargins = New Infragistics.Win.ImageBackgroundStretchMargins(0, 2, 0, 3)
        Appearance43.ImageBackgroundStyle = Infragistics.Win.ImageBackgroundStyle.Stretched
        Me.grdDataMain.DisplayLayout.GroupByBox.Appearance = Appearance43
        Me.grdDataMain.DisplayLayout.GroupByBox.ButtonBorderStyle = Infragistics.Win.UIElementBorderStyle.None
        ...
        Me.grdDataMain.DisplayLayout.Override.AllowDelete = Infragistics.Win.DefaultableBoolean.[True]
        ...
        Me.grdDataMain.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.None
        Me.grdDataMain.DisplayLayout.Override.BorderStyleHeader = Infragistics.Win.UIElementBorderStyle.None
        Me.grdDataMain.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.None
        Me.grdDataMain.DisplayLayout.Override.ButtonStyle = Infragistics.Win.UIElementButtonStyle.FlatBorderless
        Appearance44.BackColor = System.Drawing.Color.Transparent
        Me.grdDataMain.DisplayLayout.Override.CardAreaAppearance = Appearance44
        Appearance45.BorderColor = System.Drawing.Color.Transparent
        Appearance45.FontData.Name = "Verdana"
        Me.grdDataMain.DisplayLayout.Override.CellAppearance = Appearance45
        Appearance46.ForeColor = System.Drawing.Color.FromArgb(CType(CType(21, Byte), Integer), CType(CType(27, Byte), Integer), CType(CType(85, Byte), Integer))
        Appearance46.ImageBackground = CType(resources.GetObject("Appearance46.ImageBackground"), System.Drawing.Image)
        Appearance46.ImageBackgroundStretchMargins = New Infragistics.Win.ImageBackgroundStretchMargins(6, 3, 6, 3)
        Appearance46.ImageBackgroundStyle = Infragistics.Win.ImageBackgroundStyle.Stretched
        Me.grdDataMain.DisplayLayout.Override.CellButtonAppearance = Appearance46
        Me.grdDataMain.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Appearance47.BackColor = System.Drawing.Color.FromArgb(CType(CType(240, Byte), Integer), CType(CType(248, Byte), Integer), CType(CType(251, Byte), Integer))
        Me.grdDataMain.DisplayLayout.Override.FilterCellAppearance = Appearance47
        ...
        Appearance48.ImageBackgroundStretchMargins = New Infragistics.Win.ImageBackgroundStretchMargins(6, 3, 6, 3)
        Me.grdDataMain.DisplayLayout.Override.FilterClearButtonAppearance = Appearance48
        ...
        Me.grdDataMain.DisplayLayout.Override.FilterOperatorDropDownItems = Infragistics.Win.UltraWinGrid.FilterOperatorDropDownItems.Contains
        Appearance49.BackColor = System.Drawing.Color.FromArgb(CType(CType(251, Byte), Integer), CType(CType(251, Byte), Integer), CType(CType(251, Byte), Integer))
        Appearance49.BackColorAlpha = Infragistics.Win.Alpha.Opaque
        Me.grdDataMain.DisplayLayout.Override.FilterRowPromptAppearance = Appearance49
        ...
        Appearance50.FontData.Name = "Trebuchet MS"
        Appearance50.FontData.SizeInPoints = 10.0!
        Appearance50.ForeColor = System.Drawing.Color.FromArgb(CType(CType(85, Byte), Integer), CType(CType(85, Byte), Integer), CType(CType(85, Byte), Integer))
        Appearance50.ImageBackground = CType(resources.GetObject("Appearance50.ImageBackground"), System.Drawing.Image)
        Appearance50.ImageBackgroundStyle = Infragistics.Win.ImageBackgroundStyle.Tiled
        Appearance50.TextHAlignAsString = "Left"
        Appearance50.ThemedElementAlpha = Infragistics.Win.Alpha.Transparent
        Me.grdDataMain.DisplayLayout.Override.HeaderAppearance = Appearance50
        Me.grdDataMain.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.XPThemed
        Appearance51.BorderColor = System.Drawing.Color.Transparent
        Me.grdDataMain.DisplayLayout.Override.RowAppearance = Appearance51
        ...
        Me.grdDataMain.DisplayLayout.Override.RowSelectorAppearance = Appearance52
        Appearance53.BorderColor = System.Drawing.Color.Transparent
        Appearance53.ForeColor = System.Drawing.Color.Black
        Me.grdDataMain.DisplayLayout.Override.SelectedCellAppearance = Appearance53
        Appearance54.BorderColor = System.Drawing.Color.Transparent
        Appearance54.ForeColor = System.Drawing.Color.FromArgb(CType(CType(21, Byte), Integer), CType(CType(27, Byte), Integer), CType(CType(85, Byte), Integer))
        Appearance54.ImageBackground = CType(resources.GetObject("Appearance54.ImageBackground"), System.Drawing.Image)
        Appearance54.ImageBackgroundStretchMargins = New Infragistics.Win.ImageBackgroundStretchMargins(1, 1, 1, 4)
        Appearance54.ImageBackgroundStyle = Infragistics.Win.ImageBackgroundStyle.Stretched
        Me.grdDataMain.DisplayLayout.Override.SelectedRowAppearance = Appearance54
        ...
        Me.grdDataMain.DisplayLayout.Override.SupportDataErrorInfo = Infragistics.Win.UltraWinGrid.SupportDataErrorInfo.CellsOnly
        ...
        Appearance55.ImageBackgroundStretchMargins = New Infragistics.Win.ImageBackgroundStretchMargins(2, 4, 2, 4)
        Appearance55.ImageBackgroundStyle = Infragistics.Win.ImageBackgroundStyle.Stretched
        ScrollBarLook1.Appearance = Appearance55
        Appearance56.ImageBackground = CType(resources.GetObject("Appearance56.ImageBackground"), System.Drawing.Image)
        Appearance56.ImageBackgroundStretchMargins = New Infragistics.Win.ImageBackgroundStretchMargins(3, 2, 3, 2)
        ScrollBarLook1.AppearanceHorizontal = Appearance56
        Appearance57.ImageBackground = CType(resources.GetObject("Appearance57.ImageBackground"), System.Drawing.Image)
        Appearance57.ImageBackgroundStretchMargins = New Infragistics.Win.ImageBackgroundStretchMargins(2, 3, 2, 3)
        Appearance57.ImageBackgroundStyle = Infragistics.Win.ImageBackgroundStyle.Stretched
        ScrollBarLook1.AppearanceVertical = Appearance57
        Appearance58.ImageBackground = CType(resources.GetObject("Appearance58.ImageBackground"), System.Drawing.Image)
        Appearance58.ImageBackgroundStretchMargins = New Infragistics.Win.ImageBackgroundStretchMargins(0, 2, 0, 1)
        ScrollBarLook1.TrackAppearanceHorizontal = Appearance58
        Appearance59.ImageBackground = CType(resources.GetObject("Appearance59.ImageBackground"), System.Drawing.Image)
        Appearance59.ImageBackgroundStretchMargins = New Infragistics.Win.ImageBackgroundStretchMargins(2, 0, 1, 0)
        Appearance59.ImageBackgroundStyle = Infragistics.Win.ImageBackgroundStyle.Stretched
        ScrollBarLook1.TrackAppearanceVertical = Appearance59
        Me.grdDataMain.DisplayLayout.ScrollBarLook = ScrollBarLook1
        ...
        Me.grdDataMain.UseOsThemes = Infragistics.Win.DefaultableBoolean.[False]
        '
        'Tbl_consumo_aguaTableAdapter1
        '
        ...
        CType(Me.uneUltimaLectura, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txtNoServs, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.ucoRuta, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.txtFechaContrato, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.grpRegistro, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.txtFechaCaptura, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.TblconsumoaguaBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.DsAguaBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txtBimestre, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.ColoniasBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.ErrorProvider1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.grpConsumo, System.ComponentModel.ISupportInitialize).EndInit()
        Me.grpConsumo.ResumeLayout(False)
    ...
    Friend WithEvents grpRegistro As Infragistics.Win.Misc.UltraExpandableGroupBox
    ...
    Friend WithEvents ColoniasBindingSource As BindingSource
    ...
    Friend WithEvents grpConsumo As Infragistics.Win.Misc.UltraExpandableGroupBox
    Friend WithEvents UltraExpandableGroupBoxPanel3 As Infragistics.Win.Misc.UltraExpandableGroupBoxPanel
    Friend WithEvents uneUltimaLectura As Infragistics.Win.UltraWinEditors.UltraNumericEditor
    Friend WithEvents txtNoServs As Infragistics.Win.UltraWinEditors.UltraNumericEditor
    Friend WithEvents ucoRuta As Infragistics.Win.UltraWinGrid.UltraCombo
    Friend WithEvents lblUltLectura As Infragistics.Win.Misc.UltraLabel
    Friend WithEvents lblNumServs As Infragistics.Win.Misc.UltraLabel
    ...
    Friend WithEvents txtFechaContrato As Infragistics.Win.UltraWinEditors.UltraDateTimeEditor
    Friend WithEvents lblContrato As Infragistics.Win.Misc.UltraLabel
    Friend WithEvents lblMedidor As Infragistics.Win.Misc.UltraLabel
    Friend WithEvents cmbMedidor As ComboBox
    Friend WithEvents chkDrenaje As CheckBox
    ...
    Friend WithEvents DsAguaBindingSource As BindingSource
    Friend WithEvents Tbl_consumo_aguaTableAdapter1 As dsAguaTableAdapters.tbl_consumo_aguaTableAdapter
    ...
    Friend WithEvents txtBimestre As Infragistics.Win.UltraWinEditors.UltraTextEditor
    Friend WithEvents UltraLabel2 As Infragistics.Win.Misc.UltraLabel
    Friend WithEvents txtAño As Infragistics.Win.UltraWinEditors.UltraTextEditor
    Friend WithEvents txtFechaCaptura As Infragistics.Win.UltraWinEditors.UltraDateTimeEditor
