...
Public Class RptPadronAgua
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.RptPadronAgua.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPadronAgua
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPadronAgua = New RptPadronAgua()
        rpt.Site = Me.Site
        Return rpt
    End Function
