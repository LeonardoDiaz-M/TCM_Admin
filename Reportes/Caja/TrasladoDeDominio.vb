...
Public Class TrasladoDeDominio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.TrasladoDeDominio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTrasladoDeDominio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TrasladoDeDominio = New TrasladoDeDominio()
        rpt.Site = Me.Site
        Return rpt
    End Function
