...
Public Class CorteDeCajaResumen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.CorteDeCajaResumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCorteDeCajaResumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CorteDeCajaResumen = New CorteDeCajaResumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
