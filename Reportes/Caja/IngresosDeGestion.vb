...
Public Class IngresosDeGestion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.IngresosDeGestion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIngresosDeGestion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IngresosDeGestion = New IngresosDeGestion()
        rpt.Site = Me.Site
        Return rpt
    End Function
