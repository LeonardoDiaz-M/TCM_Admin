...
Public Class ReciboIngreso01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.ReciboIngreso01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReciboIngreso01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReciboIngreso01 = New ReciboIngreso01()
        rpt.Site = Me.Site
        Return rpt
    End Function
