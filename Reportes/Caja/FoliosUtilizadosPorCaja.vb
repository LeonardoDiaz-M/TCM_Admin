...
Public Class FoliosUtilizadosPorCaja
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FoliosUtilizadosPorCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.FoliosUtilizadosPorCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFoliosUtilizadosPorCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FoliosUtilizadosPorCaja = New FoliosUtilizadosPorCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
