...
Public Class PolizaIngreso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.PolizaIngreso.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Session() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPolizaIngreso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PolizaIngreso = New PolizaIngreso()
        rpt.Site = Me.Site
        Return rpt
    End Function
