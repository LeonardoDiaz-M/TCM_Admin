...
Public Class PagosConSubsidios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.PagosConSubsidios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPagosConSubsidios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PagosConSubsidios = New PagosConSubsidios()
        rpt.Site = Me.Site
        Return rpt
    End Function
