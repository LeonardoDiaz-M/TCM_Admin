...
Public Class IngresoPorDependencia
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "IngresoPorDependencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.IngresoPorDependencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIngresoPorDependencia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IngresoPorDependencia = New IngresoPorDependencia()
        rpt.Site = Me.Site
        Return rpt
    End Function
