...
Public Class AuxiliarDeIngresos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.AuxiliarDeIngresos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAuxiliarDeIngresos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AuxiliarDeIngresos = New AuxiliarDeIngresos()
        rpt.Site = Me.Site
        Return rpt
    End Function
