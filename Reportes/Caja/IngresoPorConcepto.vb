...
Public Class IngresoPorConcepto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.IngresoPorConcepto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIngresoPorConcepto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IngresoPorConcepto = New IngresoPorConcepto()
        rpt.Site = Me.Site
        Return rpt
    End Function
