...
Public Class RptHistoricoPagos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.RptHistoricoPagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptHistoricoPagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptHistoricoPagos = New RptHistoricoPagos()
        rpt.Site = Me.Site
        Return rpt
    End Function
