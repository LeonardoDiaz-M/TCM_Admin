...
Public Class RptPadronLicencias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.RptPadronLicencias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPadronLicencias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPadronLicencias = New RptPadronLicencias()
        rpt.Site = Me.Site
        Return rpt
    End Function
