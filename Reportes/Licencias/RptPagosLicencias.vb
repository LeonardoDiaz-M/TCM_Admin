...
Public Class RptPagosLicencias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TCMAdmin.RptPagosLicencias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPagosLicencias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPagosLicencias = New RptPagosLicencias()
        rpt.Site = Me.Site
        Return rpt
    End Function
